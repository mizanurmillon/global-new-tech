<x-action-section style="padding:25px 15px;" class="card">
    <x-slot name="title">
        {{ __('Delete Account') }}
    </x-slot>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-danger">
        ...
        <x-dialog-modal wire:model="confirmingUserDeletion" style="background-color: #191c24">
            <x-slot name="title">
                <div style="">
                    {{ __('Delete Account') }}
                </div>
            ...
            <x-slot name="content" class="text-danger">
            ...
            <x-slot name="footer">
                ...
                <x-button class="ml-3 btn btn-danger" wire:click="deleteUser" wire:loading.attr="disabled">
                    {{ __('Delete Account') }}
                </x-button>
            </x-slot>
        </x-dialog-modal>
